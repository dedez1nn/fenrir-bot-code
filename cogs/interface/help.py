...
PAGES = [
    ...
    },
    {
        ...
        "commands": [
            ...
            ("!adicionar_item <nome> <preco> <cooldown_h> <descricao>", "Adicionar um item à loja *(ADM)*"),
    ...
    },
    {
        ...
        "commands": [
            ...
            ("!adicionar-xp <membro> <quantidade>", "Adiciona XP a um membro *(ADM)*"),
            ("!config_voz <intervalo> <xp_quantidade>", "Configura XP por tempo em voz *(ADM)*"),
        ],
    },
    {
        "title": "Aventura",
    ...
    },
    {
        ...
        "commands": [
            ...
            ("!guild_adicionar_xp <quantidade>", "Adiciona XP à guild *(ADM)*"),
        ],
    },
    {
        "title": "Moderação",
        ...
        "commands": [
            ("!addrole <usuario> <cargo>", "Adiciona um cargo a um usuário *(ADM)*"),
            ("!addrole-all <cargo>", "Adiciona um cargo a todos os usuários *(ADM)*"),
            ("!removerole <usuario> <cargo>", "Remove um cargo de um usuário *(ADM)*"),
            ...
            ("!infractions <usuario>", "Lista infrações de um usuário *(mod)*"),
            ("!antispam_status / !antispam_reset / !antispam_whitelist / !antispam_threshold / !antispam_canal_log / !antispam_toggle", "Administração do Anti-Spam *(mod)*"),
            ("!antinuke_status / !antinuke_modo / !antinuke_whitelist / !antinuke_ping_admin / !antinuke_canal_log / !antinuke_lockdown / !antinuke_unlock / !antinuke_reset_severidade / !antinuke_toggle", "Administração do Anti-Nuke *(ADM)*"),
            ("!blacklist_add / !blacklist_remove", "Gestão manual da blacklist *(mod)*"),
        ],
    },
]
